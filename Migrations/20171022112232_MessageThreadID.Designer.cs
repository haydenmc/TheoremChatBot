...
namespace TheoremSlackBot.Migrations
{
    ...
    [Migration("20171022112232_MessageThreadID")]
    partial class MessageThreadID
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Theorem.Models.SavedDataPair", b =>
                {
            ...
            modelBuilder.Entity("Theorem.Models.Events.ChannelCreatedEventModel", b =>
                {
                    b.HasBaseType("Theorem.Models.Events.EventModel");


                    b.ToTable("ChannelCreatedEventModel");

                    b.HasDiscriminator().HasValue("ChannelCreatedEventModel");
                });
            ...
            modelBuilder.Entity("Theorem.Models.Events.MessageEventModel", b =>
                {
                    ...
                    b.Property<decimal>("SlackTimeSent");

                    b.Property<decimal>("SlackThreadID");
